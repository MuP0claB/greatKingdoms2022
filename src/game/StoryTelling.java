...
public class StoryTelling {
    ...
    public static void seaHeroInfo() {
        System.out.println("After arriving on the island, Triton The Great gets acquainted with the locals, who tell him" +
                "about the legend of the terrifying monster inhabiting the island, named DAGON.\n" +
    ...
    public static void madInfo() {
        System.out.println("After arriving in the desert, the hero Mad Max encounters the local inhabitants who tell him" +
                "about the legend of the fearsome monster - the SPHINX.\n" +
    ...
    public static void printVictoriaGratitude() {
    ...
    public static void printMelissaGratitude() {
    ...
    public static void printLolaFerrariGratitude() {
        System.out.println("Mad Max emerged victorious, rescuing Lola Ferrari and bringing light back to the kingdom.\n" +
    ...
    public static void printWinStory() {
        ...
        switch (GameData.currentHero.location.getPrincessName()) {
            case VICTORIA -> printVictoriaGratitude();
            case MELISSA -> printMelissaGratitude();
            case LOLA_FERRARI -> printLolaFerrariGratitude();
        }
